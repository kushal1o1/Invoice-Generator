...
def add_item():
    ...
    if len(desc) > 0 and not (all(i == 0 for i in invoice_item[1:])): 
...
def generate_invoice():
    ...
    if  len(invoice_list) == 0:
        messagebox.showwarning("Error", "No items added to the invoice.")   
    elif len(first_name_entry.get()) ==0 and len(last_name_entry.get())==0:
        messagebox.showwarning("Error", "No Username added to the invoice.")   
    else:    
        ...
        messagebox.showinfo("Invoice Complete", "Invoice has been Completed !")
